...
export const fetchStaffByUserId = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.get(`http://46.202.163.75:3008/api/v1/staffs/user/${userId}`);
...
export const createStaff=createAsyncThunk(
  ...
  async (newStaffData, { rejectWithValue }) => {
    try {
      const response = await axios.post('http://46.202.163.75:3008/api/v1/staffs-or', newStaffData);
      if (response.data.success) {
...
export const deleteStaff = createAsyncThunk(
  ...
  async (staffId, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.delete(`http://46.202.163.75:3008/api/v1/staff/${staffId}`);
      if (response.data.success) {
...
export const updateStaff = createAsyncThunk(
  ...
  async ({ staffId, updateData }, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.put(`http://46.202.163.75:3008/api/v1/staff/${staffId}`, updateData);
      if (response.data.success) {
