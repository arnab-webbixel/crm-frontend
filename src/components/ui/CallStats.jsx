  ...
  return (
    <div className="bg-white rounded-3xl p-6 shadow-lg w-[320px]">
      <div className="flex justify-between items-start mb-2">
        <div>
          <h2 className="text-xl font-bold text-gray-800">Today's Call</h2>
          <p className="text-sm text-gray-500">Total calls as of {date}</p>
        </div>
      ...
      <div className="mt-4 text-sm text-gray-500">
        Trending up by <span className="text-green-500">{trend}%</span> this month
      </div>
